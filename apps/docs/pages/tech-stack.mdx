...
In our repository, we have a shared UI library (uses shadcn under the hood which laverag radix), this shared library contains reusable components and styles shared across multiple projects. We chose to create a shared UI library for the following reasons:
